...
public class JuiceUI extends FrameUI implements ActionListener {
    // ItemCost object
    ...
    // item list
    // item array
    String[] itemString = new String[] { "Mango Juice", "Apple Juice", "Orange Juice", "Lemonade", "Grape Juice",
            "Pineapple Juice" };
    // item list
