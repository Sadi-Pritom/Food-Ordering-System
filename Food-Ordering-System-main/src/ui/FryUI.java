...
public class FryUI extends FrameUI implements ActionListener {
    // ItemCost object
    ...
    // item list
    // item array
    String[] itemString = new String[] { "Standard Fries", "Sweet Potato Fries", "Crinkle Cut Fries", "Garlic Fries",
            "Waffle Fries", "Potato Wedges" };
    // item list
