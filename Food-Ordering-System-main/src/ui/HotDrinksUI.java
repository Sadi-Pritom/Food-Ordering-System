...
public class HotDrinksUI extends FrameUI implements ActionListener {
    // ItemCost object
    ...
    // item list
    // item array
    String[] itemString = new String[] { "Milk Tea", "Green Tea", "Lemon Tea", "Black Coffie", "Milk Coffie",
            "cappuccino" };
    // item list
    ...
    public void createFrame() {
        ...
        String loc = "res/hotDrinks.jpg";
        this.setContentPane(new JLabel(new ImageIcon(loc)));
        // setting title
        this.setTitle("Hot Drinks");
