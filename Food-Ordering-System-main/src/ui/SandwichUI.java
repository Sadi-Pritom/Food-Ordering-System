...
public class SandwichUI extends FrameUI implements ActionListener {
    // ItemCost object
    ...
    // item list
    // item array
    String[] itemString = new String[] { "Ultimate Club Sandwich", "Supreme Club Sandwich", "Garden Club Sandwich",
            "Chicken&Cheese Club Sandwich", "Cheese Club Sandwich", "Mutton Sandwich" };
    // item list
    ...
    public void createFrame() {
        ...
        String loc = "res/sandwich.jpg";
        this.setContentPane(new JLabel(new ImageIcon(loc)));
        // setting title
        this.setTitle("Sandwich");
        ...
        textTotalCost = new JLabel("TOTAL COST:   " + queue.totalCost + "TK");
        // price lebel
        for (int i = 0; i < it; i++) {
