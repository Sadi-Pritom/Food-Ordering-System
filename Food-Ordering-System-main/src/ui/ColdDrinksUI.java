...
public class ColdDrinksUI extends FrameUI implements ActionListener {
    // ItemCost object
    ...
    // item list
    // item array
    String[] itemString = new String[] { "Mojo", "Sprite", "7up", "Coca Cola", "Mount & Dew", "Fanta" };
    // item list
    ...
    public void createFrame() {
        ...
        String loc = "res/coldDrinks.jpg";
        this.setContentPane(new JLabel(new ImageIcon(loc)));
        // setting title
        this.setTitle("Cold Drinks");
