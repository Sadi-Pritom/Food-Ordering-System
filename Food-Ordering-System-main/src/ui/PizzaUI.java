...
public class PizzaUI extends FrameUI implements ActionListener {
    // ItemCost object
    ...
    // item list
    // item array
    String[] itemString = new String[] { "Spicey Chicken Pizza", "BBQ Temptation Pizza", "Chicken Hawaiian Pizza",
            "Spicy Beef Pizza", "Beef Pepperoni Pizza", "Vegi Pizza" };
    // item list
