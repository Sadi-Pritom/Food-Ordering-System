...
public class CakesUI extends FrameUI implements ActionListener {
    // ItemCost object
    ...
    // item list
    // item array
    String[] itemString = new String[] { "Ultimate Chocolate Utopia Cake", "New York Cheese Cake",
            "White Lavender Cheese Cake", "Icecream Sundaes", "Red Velvet Cake", "Apple Crisp" };
    // item list
